...
DATABASE_URL = os.environ['DATABASE_URL'] = 'postgres://ljpncxocgcdnrv:3d9f4b3c5e82ae0c31e8911933331d1a14454d9e1da80c12be7b5406e46bd0a9@ec2-184-73-192-172.compute-1.amazonaws.com:5432/dmue7v3embfu8'
...
for x in arrayEpisodios:
    print(x)
    cur.execute('INSERT INTO public.episodios (id,nome,filler,view,likes) VALUES (%s,%s,%s,%s,%s);', (x['episodio'],x['nome'],x['filler'],0,0))
    conn.commit()